...
import { getTwoFactorConfirmationByUserId, deleteTwoFactorConfirmationById } from '@/services/two-factor-confirmation'
      ...
      switch (error.type) {
        ...
        case 'OAuthAccountNotLinked':
          return response({
            ...
            error: {
              code: 403,
              message: 'Another account already registered with the same Email Address. Please login the different one.'
            }
          })
