...
import { deleteTwoFactorTokenById, generateTwoFactorToken, getTwoFactorTokenByEmail } from '@/services/two-factor-token'
...
export const twoFactor = async (payload: z.infer<typeof twoFactorSchema>, credentials: z.infer<typeof loginSchema>) => {
